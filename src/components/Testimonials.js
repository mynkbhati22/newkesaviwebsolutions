  ...
  return (
    <>
      <div className="testimonials-container">
        ...
        <h4 className="testi-1">What our clients say about us.</h4>
        <p className="testi-2">
                ...
                <div className="carousel-item active">
                  <div className="square-container">
                    <div className="box-2">
                      ...
                      I come back to them and they always have a solution ready.
                ...
                <div className="carousel-item">
                  <div className="square-container">
                    <div className="box-2">
                      ...
                      I can trust. My clients are happy with KWS services and I
